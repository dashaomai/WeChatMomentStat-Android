...
import moe.chionlab.wechatmomentstat.tasks.UploadParameter;
import moe.chionlab.wechatmomentstat.tasks.UploadTask;
...
public class Task {
    ...
    public static void saveToJSONFileAndUpload(ArrayList<SnsInfo> snsList, String fileName, boolean onlySelected) {
        ...
        // 提交到服务器上
        final String url = "http://192.168.9.195:5000/social/moment";
        try {
            new UploadTask().execute(new UploadParameter(url, fileName));
